...
HUGGINGFACE_MODEL = get_config("HUGGINGFACE_MODEL", "microsoft/DialoGPT-medium")  # Text generation model
...
SCALEDOWN_API_KEY = get_config("SCALEDOWN_API_KEY", "dCwhMCtyGn7PdlnYGoaTI9X0oITDMDyO9vMZMgJ8")
